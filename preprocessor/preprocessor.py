...
def encode_and_index_events(
    ...
    encode_event_fn: Callable[[ES, T, Codec], Sequence[Event]],
    codec: Codec,
    frame_times: Sequence[float],
    encoding_state_to_events_fn: Optional[Callable[[ES], Sequence[Event]]] = None,
...
def extract_sequence_with_indices(
    ...
    if state_events_end_token is not None:
        ...
        segmented_events = torch.concat(
            (state_events[state_event_start_idx:state_event_end_idx], segmented_events),
            dim=0,
        )
